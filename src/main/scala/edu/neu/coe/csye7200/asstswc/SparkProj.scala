...
object AllstateClaimsSeverityRandomForestRegressor {
  ...
  case class Params(trainInput: String = "/Users/sdjtu/Desktop/7200FINAL/allstate-claims-severity/train.csv",
                    testInput: String = "/Users/sdjtu/Desktop/7200FINAL/allstate-claims-severity/test.csv",
                    outputFile: String = "/Users/sdjtu/Desktop/7200FINAL/allstate-claims-severity/output.csv",
                    algoNumTrees: Seq[Int] = Seq(24),
                    algoMaxDepth: Seq[Int] = Seq(12),
